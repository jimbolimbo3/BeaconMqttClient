...
public class BeaconPannel extends JPanel implements MqttConnNotify{
    ...
    public BeaconPannel(){
    	...
    	String strMqttSrv = BeaconConfig.getPropertyValue(CFG_MQTT_SRV_URL, mMqttClient.getHostAddr());
    	this.textMqttSrv.setText(strMqttSrv);
    	
    	String strMqttPublishTopic = BeaconConfig.getPropertyValue(CFG_MQTT_PUBLISH_TOPIC, mMqttClient.getPublishTopic());
    	this.textGwID.setText(strMqttPublishTopic);
    	
    	String strMqttUserName = BeaconConfig.getPropertyValue(CFG_MQTT_USR_NAME, mMqttClient.getUserName());
    	this.textMqttUser.setText(strMqttUserName);
    	
    	String strMqttUserPassword = BeaconConfig.getPropertyValue(CFG_MQTT_USR_PASSWORD, mMqttClient.getPassword());
    	...
    	buttonConn.addActionListener(new ActionListener(){
    		 public void actionPerformed(ActionEvent e) {
    			 ...
    			 if (!mMqttClient.isConnected())
    			 {
    				 ...
    				 BeaconConfig.savePropertyValue(CFG_MQTT_PUBLISH_TOPIC, strMqttPublishTopic);
    	...
    	buttonPushMsg.addActionListener(new ActionListener(){
     		 public void actionPerformed(ActionEvent e)
     		 {
     			 ...
     			 try
     			 {
	     			 ...
	     			 BeaconConfig.savePropertyValue(LAST_LOAD_JSON_FILE_PATH, strDirectory);
    ...
    public boolean openJsonFile()
    {
	    ...
	    String strLastDirectory = BeaconConfig.getPropertyValue(LAST_LOAD_JSON_FILE_PATH, ".");
